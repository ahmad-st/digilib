...
<html lang="en">
    <head>
		...
		<!-- App css -->
		<link href="<?= base_url() ?>assets/css/config/creative/bootstrap.min.css" rel="stylesheet" type="text/css" id="bs-default-stylesheet" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="<?php echo base_url(); ?>Auth/loginAuth" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="email" name="user_id" id="emailaddress" required="" placeholder="Enter your email">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-white-50">Don't have an account? <a href="../signup" class="text-white ms-1"><b>Sign Up</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
